...
curl -L -o "$HOME/Applications/Bitwarden/bitwarden.deb" https://bitwarden.com/download/?app=desktop&platform=linux&variant=deb
sudo apt install "$HOME/Applications/Bitwarden/bitwarden.deb"
#Obsidian installation
curl -L -o "$HOME/Applications/Obsidian/obsidian.deb" https://github.com/obsidianmd/obsidian-releases/releases/download/v1.8.10/obsidian_1.8.10_amd64.deb
sudo apt install "$HOME/Applications/Obsidian/obsidian.deb"
